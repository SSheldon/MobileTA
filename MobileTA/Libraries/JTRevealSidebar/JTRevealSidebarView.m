...
+ (JTRevealSidebarView *)defaultViewWithFrame:(CGRect)frame {
    ...
    JTNavigationView *sidebarView = [[JTNavigationView alloc] initWithFrame:CGRectMake(0, 0, 270, CGRectGetHeight(frame))];
    {
    ...
    JTNavigationView *contentView = [[JTNavigationView alloc] initWithFrame:(CGRect){CGPointZero, frame.size} animationStyle:JTNavigationViewAnimationStyleCoverUp];
    {
