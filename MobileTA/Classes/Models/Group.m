...
+ (NSArray *)allPossibleColorItems {
  ...
  if (items == nil) {
    items = @[
              @[@"Pink",UIColorFromRGB(0xFADADD)],
              @[@"Teal", UIColorFromRGB(0x00FF99)],
              @[@"Purple", UIColorFromRGB(0xA200AB)],
              ...
              @[@"Purple Nurple", UIColorFromRGB(0xBF36FF)],
              @[@"Cerulean Blue", UIColorFromRGB(0x009BDD)],
              @[@"Princess Peach", UIColorFromRGB(0xFFBBA8)],
              @[@"Goldenrod City", UIColorFromRGB(0xE3DF00)],
              @[@"Pokemon Leafgreen", UIColorFromRGB(0x006E1A)],
    ];
  }
  return items;
}
